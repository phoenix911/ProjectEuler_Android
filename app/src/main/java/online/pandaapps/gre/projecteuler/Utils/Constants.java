...
public class Constants {
    ...
    public static final String spName = "SP_general";
    public static final String version = "version";
    public static final String dateDB = "date";
    public static final String urlDate = "http://pandaapps.online/11235813/date.json";
    ...
    public static final String col2Date = "DATE";
    public static final String col3Time = "TIME";
    public static final String col4Difficulty = "DIFFICULTY";
    public static final String col5Title = "TITLE";
    ...
    // started working on version 1.1
    //currently adding offline access
}
